...
describe('<GoalsSelector />', () => {
  ...
  it('should contain goals subtitle', () => {
  ...
  it('should render correct number of goals and should have correct goal labels', () => {
    goalsData.forEach((goal, index) => {
      const testId = `goal-tag-${index}`;
      cy.assertByTestId(testId).should('have.text', goal.label);
    });
  });

  // cash crop growth window

  it('should contain cashcrop window subtitle', () => {
