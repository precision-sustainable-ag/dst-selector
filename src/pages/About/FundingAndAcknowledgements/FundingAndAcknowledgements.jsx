...
const FundingAndAcknowledgements = () => (
  <Box sx={{ border: 0.5, borderColor: 'grey.300' }} ml={2} mr={2} mt={5}>
    <Typography variant="body1" align="left">
      This material is based upon work supported by the Northeast Sustainable Agriculture Research
      and Education program (subaward # ENE 16-144), a USDA NIFA postdoctoral fellowship (grant #
      2016-67012-24711), a NIFA SAS CAP grant (project # NC09873), a NIFA OREI grant (project #
      MD.W-2015-07406), USDA ARS and NRCS, and Purdue University.
    </Typography>
  </Box>
);
