...
const AboutNew = () => {
  ...
  const pageSections = [
    { id: 0, title: 'History and Purpose of the NECCC Tool Effort' },
    { id: 1, title: 'Cover Crop Data' },
    { id: 2, title: 'Tool Design Process' },
    { id: 3, title: 'Many Thanks to Our Funders' },
    { id: 4, title: 'Contact Us' },
    { id: 5, title: 'About the Experts' },
  ];
      ...
      <Box sx={{ border: 0.5, borderColor: 'grey.300' }} ml={2} mr={2} mt={5}>
        <Grid container spacing={0} justifyContent="center" mt={4} mb={5} pt={3}>
          ...
          <Grid item xs={12} sm={12} md={7} lg={7} xl={7}>
            <div style={{ border: `1px solid ${CustomStyles().darkGreen}` }}>
