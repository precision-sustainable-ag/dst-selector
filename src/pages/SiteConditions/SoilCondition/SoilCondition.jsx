...
const SoilCondition = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://74.151.176.96/v2/attribute?filtered=false&slug=flooding_frequency&${query}`)
      .then((res) => res.json())
      .then((data) => {
    ...
    fetch(`http://74.151.176.96/v1/attribute-values?slug=soil_drainage&${queryStringRedux}`)
      .then((res) => res.json())
      .then((data) => {
