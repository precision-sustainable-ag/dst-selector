  ...
  return (
    <div className="gprogress">
      ...
      <div className="progress-diagram">
        <div id="step1" className={checkProgressStatus(state.progress, 1)}></div>

        <div id="step2" className={checkProgressStatus(state.progress, 2)}></div>

        <div id="step3" className={checkProgressStatus(state.progress, 3)}></div>

        <div id="step4" className={checkProgressStatus(state.progress, 4)}></div>
      </div>
    </div>
  );
};
