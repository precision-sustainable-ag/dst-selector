...
const InformationSheet = (props) => {
  ...
  const name = props.match.params.cropName ? props.match.params.cropName : 'none';
    ...
    <div className="wrapper container-fluid" ref={ref}>
      <header className="row greenHeader">
        <div className="col-10">
          ...
          <span className="pr-2">
            <Button href={`/csv/${crop['Cover Crop Name']}.csv`} style={{ color: 'white' }}>
              <FormatListBulleted />
              &nbsp; SPREADSHEET
            </Button>
          </span>
        ...
        <div className="col-6">
          <div className="row coverCropNames">
            <div className="col-12 coverCropGroup">
              <Typography variant="body1" className="text-uppercase text-muted font-weight-bold">
            ...
            <div className="col-12 coverCropName">
              ...
              <Typography variant="subtitle2" display="inline" className="text-muted font-italic">
